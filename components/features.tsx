        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-emerald-200/65">
              Open AI reads and understands your files, and with nothing more than a single line of feedback, so you can
          ...
          {/* Items */}
          <div className="mx-auto flex flex-wrap justify-center gap-6 md:flex-nowrap md:gap-4 lg:gap-6">
            <article className="flex-1 min-w-[250px]">
              <svg className="mb-3 fill-emerald-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">Project Milestones</h3>
            ...
            <article className="flex-1 min-w-[250px]">
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">Strategic Initiatives</h3>
              <p className="text-emerald-200/65">
                Track progress across custom flows for your team. Find the right balance for the user, privacy and
                security.
              </p>
            ...
            <article className="flex-1 min-w-[250px]">
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">Flexible Workflows</h3>
              <p className="text-emerald-200/65">
                Track progress across custom flows for your team. Find the right balance for the user, privacy and
                security.
              </p>
            ...
            <article className="flex-1 min-w-[250px]">
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">Unified Timeline</h3>
              <p className="text-emerald-200/65">
                Track progress across custom flows for your team. Find the right balance for the user, privacy and
                security.
              </p>
